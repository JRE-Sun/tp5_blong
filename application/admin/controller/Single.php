...
class Single extends \app\admin\controller\Base
{
    ...
    public function add() {
        ...
        $this->redirect('/public/index.php/admin/single/index', 302);
    }
...
//            $this->success('更新成功!', '/public/index.php/admin/article/index');
        ...
        $this->error('更新失败!', '/public/index.php/admin/single/index');
    }
    /**
     * 删除文章
     *
    ...
    public function delete() {
        ...
        $this->error('删除失败!', '/public/index.php/admin/single/index');
    }
    ...
    public function release() {
        ...
        $this->error('发布失败!', '/public/index.php/admin/single/index');
    }
}
